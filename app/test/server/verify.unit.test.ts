...
void describe('verify', () => {
  ...
  void describe('jwtChallenges', () => {
    ...
    void it('"jwtUnsignedChallenge" is not solved for forged unsigned alg-none token with email jwtn3d@juice-sh.op', () => {
    ...
    void it('"jwtUnsignedChallenge" is not solved for forged unsigned alg-none token with string jwtn3d@', () => {
    ...
    void it('"jwtForgedChallenge" is not solved for HMAC-with-public-PEM forged token with email rsa_lord@juice-sh.op', { skip: isWindows() ? 'not supported on Windows' : false }, () => {
    ...
    void it('"jwtForgedChallenge" is not solved for HMAC-with-public-PEM forged token with string rsa_lord@', { skip: isWindows() ? 'not supported on Windows' : false }, () => {
