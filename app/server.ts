...
function configureApp (app: ReturnType<typeof express>, seq: typeof sequelize) {
  ...
  /* /ftp file download (no directory index) */ // vuln-code-snippet neutral-line directoryListingChallenge
  ...
  /* /logs file download (no directory index) */ // vuln-code-snippet neutral-line accessLogDisclosureChallenge
